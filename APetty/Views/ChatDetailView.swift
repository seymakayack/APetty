...
struct ChatDetailView: View {
    ...
    var body: some View {
            ...
            ScrollViewReader { scrollViewProxy in
                List(messages) { msg in
                    MessageRow(message: msg, currentUserProfileImageURL: currentUserProfileImageURL, contactImageURL: contactImageURL)
                        ...
                        .id(msg.id) // Her mesajın ID'sini belirt
                }
        ...
        .background(Color.white) // Ekrana dokunmayı algılamak için bir arka plan rengi ekledik
        .onTapGesture {
...
struct MessageRow: View {
    ...
    var body: some View {
        HStack {
            ...
            .padding(10) // Add padding inside the VStack to give space around the message content
            
            if message.isUserMessage {
                Spacer()
            }
        }
        .padding(.horizontal, 20) // Add horizontal padding to the HStack to give space on the left and right
    }
}
